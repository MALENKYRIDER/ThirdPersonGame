...
namespace DanceBattle
{
    public class ActionZone : MonoBehaviour
    {
        ...
        {
            return (Time.time - _startTime > + _settings.PlayThreshhold) && !IsFailed;
        }
        ...
        public void PlayStartAnimation()
        {
            ...
            _tween = _ring.transform.DOScale(_settings.PlayScale.y, _settings.PlayDuration)
                .OnComplete(OnAnimationComplite);
        }

        public void PlayPressedAnimaation()
        {
            if (_tween != null)
            {
                _tween.Kill();
        ...
        private void OnAnimationComplite()
        {
            IsFailed = true;
            _failed?.Invoke();
        }
